...
**مثال**: تو پرومتئوس، TSDB داده‌ها رو به‌صورت سری‌های زمانی مثل نمونه زیر ذخیره می‌کنه، و هر نمونه یه تایم‌استمپ و مقدار داره.

```http_requests_total{status_code="200",instance="web1.example.com:8080"}```
