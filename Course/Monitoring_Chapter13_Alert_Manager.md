...
- **اتوماسیون را بهبود دهیم**: هشدارها می‌توانند به سیستم‌های خودکار متصل شوند تا اقدامات اصلاحی یا پیشگیری کننده به صورت خودکار انجام شوند.
...
شاید به اشتباه این تصور شود که alert manager هشدار هارا تولید میکند ولی در واقع alert manager فقط مدیریت بعد از تولید هشدار را به عهده دارد و پرومتئوس مسئول تولید هشدارها بر اساس قوانین تعریف‌شده (Prometheus Rules) است.
...
<img width="633" height="323" alt="Prometheus-and-Alertmanager-Architecture" src="https://github.com/user-attachments/assets/7717a13b-719f-4d8d-afb2-c6e3b49adb43" />
