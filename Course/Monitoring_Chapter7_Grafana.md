...
```
- **توضیحات:**
  - `-d`: اجرای داکر در حالت پس‌زمینه.
  - `-p 3000:3000`: نگاشت پورت ۳۰۰۰ برای دسترسی به گرافانا.
  - `-v grafana-data:/var/lib/grafana`: ایجاد یک ولوم برای ذخیره دائمی داشبوردها.
