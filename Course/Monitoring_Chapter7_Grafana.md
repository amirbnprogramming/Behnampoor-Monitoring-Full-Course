...
<img width="1751" height="1076" alt="image" src="https://github.com/user-attachments/assets/237d6353-2621-42cf-8326-30f4884f5365" />
...
```
این کوئری در گرافانا سه مسیر( که هر مسیر بر اساس لیبل های مطرح شده ترکیبی از متد ها و مسیر درخواست است) برتر API را که بیشترین تعداد درخواست‌ها را در ۵ دقیقه گذشته داشته‌اند، نشان می‌دهد.
...
<img width="1636" height="1183" alt="image" src="https://github.com/user-attachments/assets/301808a5-aea9-4a1e-9e6f-e0abffa8abc8" />
...
- 3. **تنظیمات پنل:**
   ...
   - **واحد:** واحد را به **Requests/s** یعنی **rps** تنظیم کنید.
   - **عنوان:** «سه نرخ درخواست برتر»
4. روی **Apply** کلیک کنید.

<img width="2558" height="1186" alt="image" src="https://github.com/user-attachments/assets/1554edc8-cae8-421f-a00c-32947044149e" />
...
<img width="1857" height="812" alt="image" src="https://github.com/user-attachments/assets/88655409-42d4-406b-bc87-f6c8c08b950a" />
