...
- یا از داشبورد های از پیش آماده شده در ((/https://grafana.com/grafana/dashboards/)[https://grafana.com])[Grafana Dashboards] استفاده کنید.
- یا اینکه خودمون شخصی سازی شده یک داشبورد بسازیم .

در منوی **Dashboards**، گزینه **New Dashboard** را انتخاب کنید. در ادامه، سه نوع پنل را ایجاد می‌کنیم: **نمودار سری زمانی**، **گیج**، و **جدول**.
